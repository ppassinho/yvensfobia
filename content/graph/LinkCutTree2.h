/**
 * Author: https://github.com/defnotmee/definitely-not-a-lib
 * Date: 2026-08-25
 ...
 * Status: tested on Yosupo "Dynamic Tree Vertex Add Path Sum" and "Dynamic Tree Subtree Add Subtree Sum"
 */
